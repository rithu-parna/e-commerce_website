    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Typography sx={{ fontWeight: 'bold', color: '#000', mb: 1, fontSize: '45px' }}>Pouf Ottomans cloth</Typography>
        ...
        >
          ...
          <Typography sx={{ fontWeight: 'bold', color: '#000', mb: 1, fontSize: '45px' }}>Motozed Reclein Sofa</Typography>
          <Typography variant="body1" sx={{ color: '#1c7b6c', mb: 2, fontSize: '24px' }}>
            Special-shaped sofa for sale
          </Typography>
          <Button
